...
describe('CaixaDaLanchonete', () => {
    ...
    //testes adicionais
    test.each([
        ['com forma de pagamento numerica', 33, 'Forma de pagamento inválida!', ['cafe,1']],
        ['com quantidade negativa', 'credito', 'Quantidade inválida!', ['cafe,-2']],
        ['com mais de uma quantidade por item', 'debito', 'Item inválido!', ['cafe,1','sanduiche,1,1']],
        ['com quantidade não numerica', 'credito', 'Quantidade inválida!', ['cafe,suco','chantily,1']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
});
